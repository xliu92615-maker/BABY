    ...
    <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-transparent">
      <style>{\`
        ...
        @keyframes planeFlyMobile1 {
          0% { transform: translate(-50px, 400px) rotate(-15deg) scale(1); opacity: 0; }
          10% { opacity: 0.8; }
          90% { opacity: 0.8; }
          100% { transform: translate(1200px, 50px) rotate(-15deg) scale(1.5); opacity: 0; }
        }
        
        @keyframes planeFlyMobile2 {
          0% { transform: translate(0px, 150px) rotate(15deg) scale(0.8); opacity: 0; }
          10% { opacity: 0.6; }
          90% { opacity: 0.6; }
          100% { transform: translate(1400px, 450px) rotate(15deg) scale(1.2); opacity: 0; }
        }
        ...
        .anim-particle {
          /* specific durations applied inline */
        }
      \`}</style>
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        {/* Plane 1 */}
        <div className="absolute top-0 left-0 w-10 h-10 text-[#C5A059] opacity-0 anim-plane-1">
        ...
        <div className="absolute top-0 left-0 w-8 h-8 text-[#93C5FD] opacity-0 anim-plane-2 hidden md:block">
