        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="w-full md:w-[42%] flex flex-col order-1">
            ...
            <div className="text-slate-600 space-y-5 mb-8 leading-relaxed text-lg">
              <p>
                多年來，看著一位又一位學生在海外成長、蛻變，甚至完成學業後回到各自的專業領域發光發熱，始終是王景富主任堅持教育工作的最大動力。
              </p>
              <p>
                未來王景富主任也將持續秉持「從台灣出發，放眼世界；以知識改變人生，以視野創造未來」的教育理念，陪伴更多孩子勇敢追夢，培育具有國際競爭力、社會責任感與世界視野的新世代人才，讓教育成為改變人生最重要的力量。
              </p>
            </div>
